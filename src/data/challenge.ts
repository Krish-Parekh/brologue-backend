		...
		focusAreas: [
			{
				...
				description:
					"Define your ultimate vision and what success means to you",
				dailyChallenges: [
					{
						day: 1,
						title: "Write Your Vision Statement",
						description:
							"Spend 20 minutes writing a detailed vision of where you want to be in 12 weeks",
						actionItems: [
							"Find a quiet space",
					...
					},
					{
						...
						description:
							"List your top 5 values that will guide your decisions",
						actionItems: [
					...
					},
					{
						...
						description:
							"Create 3-5 specific, measurable goals for the next 12 weeks",
						actionItems: [
							"Make goals specific",
					...
					},
					{
						...
						description:
							'Write a powerful "why" statement that will keep you motivated',
						actionItems: [
							'Ask "why" 5 times',
							"Connect to emotions",
							"Make it personal",
					...
					},
					{
						...
						description:
							"Set up your physical and digital spaces to support your goals",
						actionItems: [
		...
		focusAreas: [
			{
				...
				dailyChallenges: [
					...
					},
					{
						...
						description:
							"Recognize patterns that serve you and those that don't",
						actionItems: [
					...
					},
					{
						...
						description:
							"Identify what triggers negative reactions or behaviors",
						actionItems: [
					...
					},
					{
						...
						description:
							"Establish a daily practice for ongoing self-awareness",
						actionItems: [
				...
				dailyChallenges: [
					{
						...
						description:
							"Identify someone who will support and hold you accountable",
						actionItems: [
		...
		focusAreas: [
			{
				...
				dailyChallenges: [
					...
					},
					{
						...
						description:
							"Acknowledge all the courageous acts you took this week",
						actionItems: [
		...
		focusAreas: [
			{
				...
				description:
					"Develop a mindset of growth and embrace learning opportunities",
				dailyChallenges: [
					{
						day: 1,
					...
					},
					{
						...
						title: "Seek Feedback",
						description:
							"Ask for constructive feedback on something you are working on",
						actionItems: [
		...
		focusAreas: [
			{
				...
				dailyChallenges: [
					...
					},
					{
						...
						description:
							"Have a meaningful conversation with someone important",
						actionItems: [
				...
				dailyChallenges: [
					{
						...
						description:
							"Begin a daily practice of writing what you are grateful for",
						actionItems: [
					...
					},
					{
						...
						description:
							"Identify what you can be grateful for in a current challenge",
						actionItems: [
